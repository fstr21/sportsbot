"""FastAPI application exposing SportsGameOdds MCP tools."""
...
try:  # pragma: no cover
    ...
    from .sgo_client import SGOClientError, get_client, shutdown_client
    from .tools import ToolSpec, get_tool, list_tools
except ImportError:  # pragma: no cover
    from config import get_settings, require_api_key  # type: ignore
    from sgo_client import SGOClientError, get_client, shutdown_client  # type: ignore
    from tools import ToolSpec, get_tool, list_tools  # type: ignore

app = FastAPI(title="SportsGameOdds MCP", version="1.0.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
